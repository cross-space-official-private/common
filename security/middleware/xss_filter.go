...
// XSSFilter provides an "auto remove XSS" from all user submitted input.
//
...
// XSSFilter implements the Gin Middleware interface.
func (mw *XSSFilter) RemoveXss() gin.HandlerFunc {
...
func (mw *XSSFilter) callRemoveXss(c *gin.Context) {
	// Bluemonday Policy
	if mw.BmPolicy == "" {
...
func (mw *XSSFilter) GetBlueMondayPolicy() *bluemonday.Policy {
...
//
func (mw *XSSFilter) XssRemove(c *gin.Context) error {
...
func (mw *XSSFilter) HandleGETRequest(c *gin.Context) error {
...
//
func (mw *XSSFilter) HandleXFormEncoded(c *gin.Context) error {
...
func (mw *XSSFilter) HandleMultiPartFormData(c *gin.Context, ctHdr string) error {
...
//}
//
func (mw *XSSFilter) HandleJson(c *gin.Context) error {
...
func (mw *XSSFilter) jsonToStringMap(buff bytes.Buffer, jsonBod interface{}) (bytes.Buffer, error) {
...
func (mw *XSSFilter) SetRequestBodyJson(c *gin.Context, buff bytes.Buffer) error {
...
func (mw *XSSFilter) ConstructJson(xmj XssMwJson, buff bytes.Buffer) bytes.Buffer {
...
func (mw *XSSFilter) buildJsonApplyPolicy(interf interface{}, buff bytes.Buffer, p *bluemonday.Policy) bytes.Buffer {
...
func (mw *XSSFilter) unravelSlice(slce []interface{}, p *bluemonday.Policy) bytes.Buffer {
	var buff bytes.Buffer
	buff.WriteByte('[')
	for _, n := range slce {
		switch nn := n.(type) {
